...
/*
 * This class manages the initialization of Respiration device
 * 
 * Author: Luis Carranco
 */
public class RespirationManager {
	/*
	...
	public static void setDeviceInitialData(String contextPath, int deviceId) {
		try {
			BufferedWriter out = new BufferedWriter(new FileWriter(contextPath
					+ "/config/respirationDevice" + deviceId + ".xml"));
			// Get the last 10 values for respiration device.
